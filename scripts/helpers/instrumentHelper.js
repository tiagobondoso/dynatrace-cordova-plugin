        ...
        return __generator(this, function (_e) {
            switch (_e.label) {
                ...
                case 1:
                    ...
                    if (!(buildProperties.iosAvailable || buildProperties.androidAvailable)) return [3, 31];
                ...
                case 5:
                    ...
                    _e.label = 6;
                case 6:
                    if (!(buildProperties.androidAvailable && (cliBuildArgs.android || cliBuildArgs.capacitor === "android"))) return [3, 18];
                    _e.label = 7;
                case 7:
                    ...
                    _b = buildProperties;
                    if (!buildProperties.isCapacitor) return [3, 9];
                ...
                case 11:
                    ...
                    if (!buildProperties.isCapacitor && buildProperties.androidAssetPath) {
                    ...
                    Logger_1.Logger.getInstance().logWarning("Not instrumenting HTML files since there is no available JSAgent to inject!");
                    return [3, 15];
                case 12:
                ...
                case 17:
                    ...
                    return [7];
                case 18:
                    if (!(buildProperties.iosAvailable && (cliBuildArgs.ios || cliBuildArgs.capacitor === "ios"))) return [3, 28];
                    _e.label = 19;
                case 19:
                ...
                case 21:
                    ...
                    if (!buildProperties.isCapacitor && buildProperties.iosAssetsPath) {
                ...
                case 29:
                    e_3 = _e.sent();
                    Logger_1.Logger.getInstance().logError(e_3);
